...
exports.processReviewers = exports.logDebug = void 0;
...
async function processReviewers(reviewers, github) {
    const reviewerList = reviewers.split(',').map(r => r.trim());
    const processedReviewers = [];
...
exports.processReviewers = processReviewers;
